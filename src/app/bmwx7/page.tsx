        ...
        <div>
            <section className="py-10">
                <div className="flex flex-col items-center text-center">
                    <p className="m-3 text-2xl font-bold">BMW X7 2024 Price in Pakistan, Images, Reviews & Specs</p>
                    <div className="flex justify-center mb-4">
                        <Image src={c4} alt="BMW X1" className="max-w-md h-auto" />
                    </div>
                    <ul className="flex">
                        <li>
                            <Link href="">
                    ...
                    <div className="m-3">
                        <button className="shadow-lg py-4 px-5 text-2xl font-bold m-2">PKR 2.9 crore</button>
